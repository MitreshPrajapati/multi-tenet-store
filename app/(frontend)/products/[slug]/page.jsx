...
const ProductDetailPage = async ({ params: { slug } }) => {
  const category = await getData("/categories/667cfb1962a0c2988be1de70");
  return (
    <div>
      <Breadcrumb />
      <div className="grid grid-cols-12 gap-6">
        ...
        <div className="col-span-12 md:col-span-6 flex flex-col">
          ...
          <div className="flex gap-4 items-center">
            <p>SKU: 234234</p>
            <p className="bg-green-200 py-2 px-4 rounded-full dark:text-slate-800">
              {" "}
              <b>Stock</b>: 43
            </p>
          </div>
          <div className="flex items-center justify-between gap-4 pb-2 border-b border-slate-500">
            <div className="flex gap-2 items-center">
              <h4 className="text-2xl text-green-500"> $500</h4>
              <del className="text-slate-400 text-sm -mt-1">$1000</del>
            </div>
          ...
          <p className="py-8">
            ...
            Reiciendis recusandae har um esse velit enim sapiente quis sed iste
            saepe, ea exercitationem aliquid distinctio provident nulla? Animi,
            rerum accusamus.
          </p>
        ...
        <div className="col-span-12 sm:col-span-3  border border-gray-200 dark:border-gray-800 text-slate-800 bg-green-100 dark:bg-slate-700 rounded-md overflow-hidden">
          ...
          <div className="px-4 py-3">
            ...
            <h2 className="dark:text-slate-200 py-2 ">Choose your Location</h2>
            <div className=" py-2">
              <label
                for="countries"
